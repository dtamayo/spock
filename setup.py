...
setup(name='spock',
    ...
    packages=['spock'],
    package_data={'spock': ['models/spock.json', 'models/feb23_best_modelv6_bbb.pt']},
    install_requires=["rebound", "celmech", "xgboost==1.0.0rc1", "numpy", "sklearn", "scipy", "torch", "pandas"],
    tests_require=["numpy"],
