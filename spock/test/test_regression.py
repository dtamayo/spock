...
class TestRegressor(unittest.TestCase):
    ...
    def test_seed(self):
        ...
        sim.add(m=1.e-5, P=2.)
        sim.add(m=1.e-5, P=3.)
        p1 = np.log10(self.model.predict_instability_time(sim, seed=0, samples=100))
        p2 = np.log10(self.model.predict_instability_time(sim, seed=1, samples=100))
        print(p1, p2)
    ...
    def test_prediction(self):
        ...
        for mass in [1e-4, 5e-5, 3e-5, 1e-5]:
            ...
            predicted_time = np.log10(self.model.predict_instability_time(sim, samples=100))
